(function (a) {
    var k = window.location.href.substr(window.location.href.lastIndexOf("https://html.creativegigstf.com/") + 1);
    ...
    a(".feedback_slider_one").length &&
        a(".feedback_slider_one").slick({ dots: !0, arrows: !1, centerPadding: "0px", slidesToShow: 3, slidesToScroll: 1, autoplay: !0, centerMode: !0, autoplaySpeed: 3e3, responsive: [{ breakpoint: 768, settings: { slidesToShow: 1 } }] });
    ...
    a(".feedback_slider_three").length && a(".feedback_slider_three").slick({ dots: !0, arrows: !1, centerMode: !0, centerPadding: "0px", slidesToShow: 1, fade: !0, autoplay: !0, autoplaySpeed: 3500 });
    a(".feedback_slider_four").length && a(".feedback_slider_four").slick({ dots: !0, arrows: !1, centerMode: !0, centerPadding: "0px", slidesToShow: 1, fade: !0, autoplay: !0, autoplaySpeed: 3500 });
    ...
    a(window).on("load", function () {
        ...
        a("[data-aos]").length && AOS.init({ duration: 800, mirror: !0, once: !0, offset: 50 });
        var b = a(".fancybox");
        ...
        if (a("#isotop-gallery-wrapper").length) {
            var c = a("#isotop-gallery-wrapper").isotope({ itemSelector: ".isotop-item", percentPosition: !0, masonry: { columnWidth: ".grid-sizer" } });
